...
namespace CGLA
{
	public struct Mathd {
		...
		internal static bool LineIntersection(Vec2d p1, Vec2d p2, Vec2d p3, Vec2d p4, ref Vec2d result) {
			...
			result = new Vec2d(p1.x + num8 * num1, p1.y + num8 * num2);
			return true;
		}
		
		internal static bool LineSegmentIntersection(Vec2d p1, Vec2d p2, Vec2d p3, Vec2d p4, ref Vec2d result) {
			double num1 = p2.x - p1.x;
			double num2 = p2.y - p1.y;
			double num3 = p4.x - p3.x;
			double num4 = p4.y - p3.y;
